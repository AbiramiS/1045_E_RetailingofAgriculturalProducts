    ...
    <table cellpadding="5" cellspacing="3" width="100%" style="background-color:#C1D4E6;">
        ...
        <asp:RequiredFieldValidator ID="rfpassword" runat="server" ControlToValidate="txtpass" ErrorMessage="Password should not be empty" ToolTip="Password should not be empty" ForeColor="Red"></asp:RequiredFieldValidator></td>
         ...
         <tr>
            ...
            <td><asp:CompareValidator ID="cvdconfrmpassword" runat="server" CausesValidation="true" ForeColor="Red" CompareToCompare="txtpass" ControlToValidate="txtconfrmpassword" ErrorMessage="Password and ConfirmPassword Must be Match" ToolTip="Password and ConfirmPassword Must be Match"></asp:CompareValidator>
