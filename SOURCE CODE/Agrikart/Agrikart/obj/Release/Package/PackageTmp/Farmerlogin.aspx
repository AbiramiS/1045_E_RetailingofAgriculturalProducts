        ...
        <table width="100%" style="background-color:#C1D4E6;">
            ...
            <tr>
             ...
             <tr>
                 ...
                 <td align="left"><asp:TextBox ID="txtfrmid" runat="server" font-size="10pt" height="25"  Width="160px"></asp:TextBox></td>
                 <td><asp:RequiredFieldValidator ID="txtuservalidate" runat="server" Controltovalidate="txtfrmid" ErrorMessage="Please enter your name..."
             ...
             <tr>
                 ...
                 <td align="left"><asp:TextBox ID="txtpassword" runat="server" Height="25" Width="160px" Font-Size="10pt"></asp:TextBox></td>
             ...
             <tr>
                 <td></td>
                 <td colspan="2" align="center"><asp:Button ID="btnSignin" Text="Login" BackColor="Green" style="width:80px; height:30px" runat="server" OnClick="btnSignin_Click" />&nbsp;&nbsp;<asp:Button ID="btnCancel" Text="Cancel" runat="server" BackColor="Orange" style="width:80px; height:30px" /></td>
                 <td></td>
             </tr>
             <tr>
