<%@ Page Title="" Language="C#" MasterPageFile="~/Farmer.Master" AutoEventWireup="true" CodeBehind="AddProducts.aspx.cs" Inherits="Agrikart.AddProducts" %>
    ...
    <table border="0" cellpadding="1" cellspacing="1" width="100%" style="background-color:#C1D4E6;" align="center">
        ...
        <tr>
            ...
            <td align="left">
             ...
             <td><p style="font-family:'Matura MT Script Capitals'; color:green;">Per KG price</p><asp:RequiredFieldValidator ID="rvprice" runat="server" forecolor="Red" ErrorMessage="Please enter the product price... " ControlToValidate="txtPrice" ToolTip="Must be fill price"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
             <td></td>
            <td align="right">
            ...
            <td align="left">
                <asp:TextBox ID="txtQuty" runat="server" AutoPostBack="true" OnTextChanged="txtQuty_TextChanged" ></asp:TextBox>
                
            </td>
             <td><p style="font-family:'Matura MT Script Capitals'; color:green;">KG</p><asp:RequiredFieldValidator ID="rfvqnty" runat="server" ForeColor="Red" ControlToValidate="txtQuty" ErrorMessage="Please enter the product quantity..." ToolTip="Must be fill Quantity"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
             <td></td>
            <td align="right">
        ...
        <tr>
            ...
            <asp:Button ID="btnsubmit" runat="server" Text="Submit" BackColor="Green"  style="width:80px; height:30px" OnClick="btnsubmit_Click" /> &nbsp;&nbsp;
                 <asp:Button ID="btnupdate" runat="server" BackColor="Orange" Text="Cancel" style="width:80px; height:30px" OnClick="btnupdate_Click" />  
            </td>   
             <td></td>       
        </tr>
        <tr>
