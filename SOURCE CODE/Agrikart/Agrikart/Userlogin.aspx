        ...
        <center>
          <table width="100%" style="background-color:#C1D4E6;">
              ...
              <tr>
                ...
                <tr>
                    <td></td>
                    <td colspan="2" align="center" ><asp:Button ID="btnSignin" Text="Login" style="width:80px; height:30px" BackColor="Green" runat="server" OnClick="btnSignin_Click" />&nbsp;&nbsp;&nbsp;<asp:Button ID="btnCancel" runat="server" BackColor="Orange" Text="Cancel" style="width:80px; height:30px" OnClick="btnCancel_Click" />
                        </td>
                    <td>                      
                    </td>
                </tr>
                ...
                <a href="UsersRegistration.aspx"><u>RegisterNow</u></a>
                    </td>
                    <td></td>           
            </tr>
              <tr>
