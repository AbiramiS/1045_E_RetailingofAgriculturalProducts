    ...
    <center>
        <table width="100%" style="background-color:#C1D4E6;">
            ...
            <tr>
                ...
                <td align="left"><asp:TextBox ID="txtpassword" runat="server" TextMode="Password" CausesValidation="true" Width="160px"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td align="left"><asp:TextBox ID="txtconfirmpassword" runat="server" TextMode="Password" CausesValidation="true" Width="160px"></asp:TextBox></td>
            ...
            <tr>
                <td></td>
                <td colspan="2" align="center"><asp:Button ID="btnsubmit" runat="server" Text="Submit"  BackColor="Green" style="width:80px; height:30px" OnClick="btnsubmit_Click" />&nbsp;&nbsp;<asp:Button ID="btncancel" BackColor="Orange" runat="server" style="width:80px; height:30px" Text="Cancel" Width="80px" OnClick="btncancel_Click" /></td>
                <td></td>
            </tr>
            <tr>
                <td colspan="4"><br /> </td>
