        ...
        <table width="100%" style="background-color:#C1D4E6;">
            ...
            <tr>
             ...
             <tr>
                <td> </td>
                <td colspan="2"> 
                    <asp:DataList ID="dlProducts" runat="server" RepeatColumns="3" Width="100%" OnItemCommand="dlProducts_ItemCommand" OnSelectedIndexChanged="dlProducts_SelectedIndexChanged">
                    <ItemTemplate>
                        <table cellpadding="1" cellspacing="2">
                            ...
                            <tr>
                                <td colspan="2" align="center" valign="top">
                                  <p style="color:goldenrod">Stock:</p><%#DataBinder.Eval(Container.DataItem,"Stock")%>KG
                                </td>
                            </tr>
                            <tr>
                                <td><br /></td>
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <b>₹ &nbsp;<%#DataBinder.Eval(Container.DataItem,"Price")%></b>.Rs</td>
                            </tr>
                            <tr>
